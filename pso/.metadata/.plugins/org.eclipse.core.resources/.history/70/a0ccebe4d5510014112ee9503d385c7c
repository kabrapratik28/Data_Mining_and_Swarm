...
public class pso_on_graph {
	...
	public pso_on_graph(Vector<Vector<Float>> graph_data ,Vector<Float> sorted_eigen_value, Vector<Vector<Float>> sorted_eigen_vector)
	{
	...
	public graph_particle give_random_particles()
	{
