...
public class particle {	
	...
	public static void main(String[] args) {
		...
		*/
		...
		random_particle_generator r1 = new random_particle_generator(particle.setting_for_all.no_of_cluster, d1.get_min_and_max_value_of_dimensions("MIN_LIWC_Feature", "MAX_LIWC_Feature", 87)) ; 
