...
public class xml_file_reader {
	...
	public xml_file_reader(String filename)
	{
		...
		if (node.getNodeType() == Node.ELEMENT_NODE) {
			...
			String database_user_data_table_name = getValue("user_value_table_name_in_database", element);
			String database_min_data_table_name = getValue("min_value_table_name_in_database", element);
			String database_max_data_table_name = getValue("max_value_table_name_in_database", element);
			...
			//LIWC.CAT location reader
			String liwc_feature_extraction_file = getValue("liwc_feature_extraction_file", element);
			
			dataset_and_parameter_settings_session = new dataset_and_parameter_settings(option_of_file_or_database, file_name, database_name, database_user_data_table_name,database_min_data_table_name, database_max_data_table_name,parameter_taken_for_pso,liwc_feature_extraction_file); 
		}		
	...
	public static void main(String[] args) {
		...
		//System.out.println(s1.dataset_and_parameter_settings_session.database_user_data_table_name);
	}
